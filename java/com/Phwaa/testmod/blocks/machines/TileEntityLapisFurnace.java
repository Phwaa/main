...
public class TileEntityLapisFurnace extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.lapis_furnace";
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack result = LapisFurnaceRecipes.getInstance().getLapisFurnaceResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = LapisFurnaceRecipes.getInstance().getLapisFurnaceResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
